...
import imgCoppyRight from "/assets/copyright.svg";
        ...
        <>
            <main className={`bg-gray-300 h-[50svh] mt-[10svh] flex justify-center items-center`}>
                <article className="w-[50%] flex justify-center">
                    <img src={imgMap} alt="Map" width="500px" />
                </article>
            ...
            <footer className={`h-[40svh] mb-[10svh] flex items-center justify-center gap-30 text-[1.5rem] relative`}>
                <article>
                ...
                <article className="absolute bottom-2">
                    <span className="flex gap-1"><img src={imgCoppyRight} alt="Copyright" /> 2025 Taste Good by ServeTH | All Rights Reserved</span>
                </article>
            </footer> 
        </>
    );
